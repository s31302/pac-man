public class Ghost2 implements Runnable {
    ...
    public Ghost2(GameP gameP, int initialX, int initialY) {
        this.gameP = gameP;
    ...
    private void animate() {
        while (true) {
            ...
            gameP.updateGhost2Image(ghostX, ghostY, ghostDirection, animationState);
        }
    }
    ...
    private void move() {
        ...
        if (gameP.isValidMove(newMoveX, newMoveY)) {
            gameP.moveGhost2(ghostX, ghostY, newMoveX, newMoveY);
            ghostX = newMoveX;
            ghostY = newMoveY;
        }
    }
