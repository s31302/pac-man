    ...
    public class Ghost4 implements Runnable {
        ...
        public Ghost4(GameP gameP, int initialX, int initialY) {
            this.gameP = gameP;
        ...
        private void animate() {
            while (true) {
                ...
                gameP.updateGhost4Image(ghostX, ghostY, ghostDirection, animationState);
            }
        }
        ...
        private void move() {
            ...
            if (gameP.isValidMove(newMoveX, newMoveY)) {
                gameP.moveGhost4(ghostX, ghostY, newMoveX, newMoveY);
                ghostX = newMoveX;
                ghostY = newMoveY;
            }
        }
